...
def parse_args():
    ...
    parser.add_argument('-c', '--config', dest='config', type=str, nargs='+', default=[],
                        help='Config ID(s) to load (e.g., -c 1 2 3 loads config_1.yaml, config_2.yaml, config_3.yaml). Multiple configs will be executed sequentially.')
